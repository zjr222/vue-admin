        ...
        <div class="nav">
          <div class="logo">
            <a-avatar class="avatar"
              src="https://img1.baidu.com/it/u=1653751609,236581088&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=500" />
          </div>
          <div class="left">
            <a-menu class="left-menu" v-model:selectedKeys="selectedKeys" theme="light" mode="horizontal"
              ...
              <a-menu-item class="menu-item" v-for="route in navRoutes" :key="route.name">
                <router-link :to="route.path">{{ route.cname }}</router-link>
              </a-menu-item>
            </a-menu>
            <a-avatar class="avatar-login"
              src="https://img1.baidu.com/it/u=1653751609,236581088&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=500" />
          </div>
